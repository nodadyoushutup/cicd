...
// the job name
def jobName = "jenkins"
// pull from the Jenkins master's environment
def repoUrl = System.getenv('JENKINS_REPOSITORY_URL')
if (!repoUrl) {
    error "Environment variable JENKINS_REPOSITORY_URL is not set!"
}

// build the XML with the dynamic URL
def configXml = """
