  ...
  exec = {
    ...
    inline = {
      jenkins = [
        ...
        "EOF",
        "cp -p /tmp/auth.groovy /home/${var.VIRTUAL_MACHINE_USERNAME}/init.groovy.d/auth.groovy",
        "cp -p /tmp/system.groovy /home/${var.VIRTUAL_MACHINE_USERNAME}/init.groovy.d/system.groovy",
        "cp -p /tmp/agent.groovy /home/${var.VIRTUAL_MACHINE_USERNAME}/init.groovy.d/agent.groovy",
...
resource "docker_image" "jenkins" {
  ...
  name = "ghcr.io/nodadyoushutup/jenkins-controller:2.496"
}
